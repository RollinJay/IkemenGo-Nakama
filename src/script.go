...
func triggerFunctions(l *lua.LState) {
	...
	luaRegister(l, "borderEnabled", func(*lua.LState) int {
		l.Push(lua.LBool(sys.presentationEnabled()))
		return 1
	})
	luaRegister(l, "borderWidth", func(*lua.LState) int {
		l.Push(lua.LNumber(sys.presentation.canvas[2]))
		return 1
	})
	luaRegister(l, "borderHeight", func(*lua.LState) int {
		l.Push(lua.LNumber(sys.presentation.canvas[3]))
		return 1
	})
	luaRegister(l, "borderGameX", func(*lua.LState) int {
		l.Push(lua.LNumber(sys.borderGameX()))
		return 1
	})
	luaRegister(l, "borderGameY", func(*lua.LState) int {
		l.Push(lua.LNumber(sys.borderGameY()))
		return 1
	})
	luaRegister(l, "borderGameWidth", func(*lua.LState) int {
		l.Push(lua.LNumber(sys.borderGameWidth()))
		return 1
	})
	luaRegister(l, "borderGameHeight", func(*lua.LState) int {
		l.Push(lua.LNumber(sys.borderGameHeight()))
		return 1
	})
	...
	luaRegister(l, "motifState", func(*lua.LState) int {
		...
		case "hiscore":
			l.Push(lua.LBool(sys.motif.hi.active))
		case "nakama":
			l.Push(lua.LBool(sys.nakama != nil && sys.nakama.IsConnected()))
		case "nakama_spectator_loading":
			l.Push(lua.LBool(sys.nakamaSpectatorLoading))
		default:
			l.RaiseError("\nInvalid argument: %v\n", strArg(l, 1))
		}
		return 1
